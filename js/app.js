...
$(function() {
  ...
  $('#intro').html('<b>Instructions:</b><br />Store up enough energy points to shoot a fireball<br /> If you attempt to shoot a fireball before you have <br />'+ powerReady + ' stored points you will lose them all <br />Duck the fireballs thrown at you by jumping out of the way<br /> If you jump your fireball jumps with you <br > First to reach ' + pointsToWin + ' points wins<br /><br /><b>Player 1:</b> <br /> A or S repeatedly to store energy points <br /> D to shoot fireballs if stored points more than ' + powerReady + '<br /> W to jump <br /><br /><b>Player 2:</b> <br /> L or ; repeatedly to store energy points <br /> " to shoot fireballs if stored points more than ' + powerReady + '<br /> P to jump')

  alert('Knock your opponent out with a fireball, but first you have to store up enough energy points! If you attempt to shoot a fireball before you have '+ powerReady + ' stored points you will lose them all and have to start from zero! Duck the fireballs thrown at you by jumping out of the way, but remember if you jump your fireball jumps with you! First to reach ' + pointsToWin + ' points wins!')
